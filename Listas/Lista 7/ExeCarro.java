...
public class ExeCarro {    public static void main(String[] args) throws Exception {
    Propietario primeiroPropietario = new Propietario("Joana", "Rua Haverá sinais", 'f', "234-452-123-82", "043");
    ...
    Propietario segundoProprietario = new Propietario("Luan", "Rua minha vida é um inferno", 'm', "234.256.234-82", "122");
